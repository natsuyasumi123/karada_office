...
public class MyNativeRender {
    ...
    public static final int TYPE_KEY_SHRINK_KOSHI      = TYPE_BASE + 0;
//    public static final int TYPE_KEY_BIG_BREAST      = TYPE_BASE + 1;
//    public static final int TYPE_KEY_BIG_EYES            = TYPE_BASE + 2;
//    public static final int TYPE_KEY_FACE_SLENDER        = TYPE_BASE + 3;
//
//
//    public static final int TYPE_SET_TOUCH_LOC           = TYPE_BASE + 999;
//    public static final int TYPE_SET_GRAVITY_XY          = TYPE_BASE + 1000;
