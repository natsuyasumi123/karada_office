...
float LeftCheekKeyPoint11[2] = {};
float ChinKeyPoint11[2] = {};
float RightCheekPoint11[2] = {};
...
void koshiSlim::Draw(int screenW, int screenH)
{
    ...
    float x = leftCurPoint.x / m_RenderImage.width, y = leftCurPoint.y / m_RenderImage.height,
            z = rightCurPoint.x / m_RenderImage.width, w = rightCurPoint.y / m_RenderImage.height ;
    GLUtils::setVec4(m_ProgramObj, "u_curCtrlPoints",x , y  , z , w );
